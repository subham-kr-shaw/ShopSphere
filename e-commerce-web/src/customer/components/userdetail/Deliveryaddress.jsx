...
import { useNavigate } from 'react-router-dom'
import { useDispatch } from 'react-redux'
import { setshippingaddress } from '../../../state/order/Action'
// ✅ createorder is NOT called here anymore — moved to Payment.jsx
...
const Deliveryaddress = () => {
    ...
    const handlesubmit = (e) => {
        ...
        // ✅ Only save address to Redux — do NOT create order yet
        dispatch(setshippingaddress(address));
